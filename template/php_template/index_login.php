...
<html lang="zh-cn">
  ...
  <div style="float:left; width:191px; height:309px;">
	...
	<div>
	 <input type="text" name="account" placeholder="E-mail" style="width:169px; font-size:16px; padding:8px 2px; margin:12px 9px 0 8px; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius: 5px;" value="" />
	 </div>
	<input type="password" name="password" placeholder="Password" style="width:169px; font-size:16px; padding:8px 2px; margin:9px 9px 0 8px;-moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius: 5px;" value="" />
